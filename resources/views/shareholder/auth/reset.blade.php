                ...
                <div class="col-md-8 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{route('client.reset.submit')}}"  method="POST" class="p-2">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control  {{ $errors->has('password') ? ' is-invalid' : '' }}" type="text" required="" id="password" name="password" placeholder="Введите ваш пароль"  value="{{ old('password', null) }}">
                    ...
                    <div class="row mt-4">
                        <div class="col-sm-12 text-center">
                            <p class="text-muted mb-0">Не приходит СМС? <a href="{{route('client.forgot')}}" class="text-dark ml-1"><b>Повторить процедуру сброса</b></a></p>
                        </div>
                    </div>
                </div>
            </div>
