        ...
        <form method="POST" action="{{ route("admin.request-fields.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('personal_data') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="personal_data" id="personal_data" value="1" {{ old('personal_data', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('read_only') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="read_only" id="read_only" value="1" {{ old('read_only', 0) == 1 ? 'checked' : '' }}>
