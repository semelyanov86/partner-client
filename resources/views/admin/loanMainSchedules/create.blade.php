...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.loanMainSchedule.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.loan-main-schedules.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_fact') ? 'is-invalid' : '' }}" type="text" name="date_fact" id="date_fact" value="{{ old('date_fact') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('main_amt_plan') ? 'is-invalid' : '' }}" type="number" name="main_amt_plan" id="main_amt_plan" value="{{ old('main_amt_plan', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('main_amt_fact') ? 'is-invalid' : '' }}" type="number" name="main_amt_fact" id="main_amt_fact" value="{{ old('main_amt_fact', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('main_amt_debt_plan') ? 'is-invalid' : '' }}" type="number" name="main_amt_debt_plan" id="main_amt_debt_plan" value="{{ old('main_amt_debt_plan', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('main_amt_debt_fact') ? 'is-invalid' : '' }}" type="number" name="main_amt_debt_fact" id="main_amt_debt_fact" value="{{ old('main_amt_debt_fact', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('percent_amt_plan') ? 'is-invalid' : '' }}" type="number" name="percent_amt_plan" id="percent_amt_plan" value="{{ old('percent_amt_plan', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('percent_amt_fact') ? 'is-invalid' : '' }}" type="number" name="percent_amt_fact" id="percent_amt_fact" value="{{ old('percent_amt_fact', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fee_plan') ? 'is-invalid' : '' }}" type="number" name="fee_plan" id="fee_plan" value="{{ old('fee_plan', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fee_fact') ? 'is-invalid' : '' }}" type="number" name="fee_fact" id="fee_fact" value="{{ old('fee_fact', '') }}" step="0.01">
