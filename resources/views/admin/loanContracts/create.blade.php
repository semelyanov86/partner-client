...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.loanContract.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.loan-contracts.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_calculate') ? 'is-invalid' : '' }}" type="text" name="date_calculate" id="date_calculate" value="{{ old('date_calculate') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('agreement') ? 'is-invalid' : '' }}" type="text" name="agreement" id="agreement" value="{{ old('agreement', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('percent') ? 'is-invalid' : '' }}" type="number" name="percent" id="percent" value="{{ old('percent', '') }}" step="0.01" required min="1" max="90">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mem_fee') ? 'is-invalid' : '' }}" type="number" name="mem_fee" id="mem_fee" value="{{ old('mem_fee', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('actual_debt') ? 'is-invalid' : '' }}" type="number" name="actual_debt" id="actual_debt" value="{{ old('actual_debt', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('full_debt') ? 'is-invalid' : '' }}" type="number" name="full_debt" id="full_debt" value="{{ old('full_debt', '') }}" step="0.01">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_open') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_open" id="is_open" value="1" {{ old('is_open', 0) == 1 ? 'checked' : '' }}>
