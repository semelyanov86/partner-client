...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.depositSchedule.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.deposit-schedules.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('deposit') ? 'is-invalid' : '' }}" name="deposit_id" id="deposit_id" required>
                    @foreach($deposits as $id => $deposit)
                        <option value="{{ $id }}" {{ old('deposit_id') == $id ? 'selected' : '' }}>{{ $deposit }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_fact') ? 'is-invalid' : '' }}" type="text" name="date_fact" id="date_fact" value="{{ old('date_fact') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('main_amt_debt') ? 'is-invalid' : '' }}" type="number" name="main_amt_debt" id="main_amt_debt" value="{{ old('main_amt_debt', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('main_amt_fact') ? 'is-invalid' : '' }}" type="text" name="main_amt_fact" id="main_amt_fact" value="{{ old('main_amt_fact', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ndfl_amt') ? 'is-invalid' : '' }}" type="number" name="ndfl_amt" id="ndfl_amt" value="{{ old('ndfl_amt', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('percent_available') ? 'is-invalid' : '' }}" type="number" name="percent_available" id="percent_available" value="{{ old('percent_available', '') }}" step="0.01">
